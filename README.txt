...
You need to download the Spring Social ORCID project from https://github.com/EuropePMC/spring-social-orcid
...
Note: be sure that you have added your application's URL, for example for development, http://localhost:8088,
...
Open your browser, and navigate to http://localhost:8088/spring-social-orcid-client-1.0.0 for instance.
